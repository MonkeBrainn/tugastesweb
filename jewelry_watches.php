...
// Set page title
$page_title = "Jewelry and Watches Collection";

// Include header
include 'header.php';

// Get jewelry and watches products from database
$query = "SELECT * FROM produk WHERE 
          idproduk IN ('p202504010', 'p202504011', 'p202504012', 'p202504013') OR 
...
<!-- Full-width container for the jewelry and watches collection -->
<div class="jewelry-watches-full-width">
    <!-- Page Header -->
    <div class="page-header">
        <h1>Jewelry and Watches Collection</h1>
        <p>Discover our exclusive Secondhand luxury accessories</p>
    </div>
    ...
    <div class="products-grid">
        <?php
        // Check if there are any jewelry and watches products
        if ($totalItems > 0) {
            ...
            // No jewelry and watches products found
            echo '<div class="no-products">';
            echo '<p>No jewelry and watches products are currently available.</p>';
            echo '</div>';
        }
