...
// Set page title
$page_title = "Ready to Wear Collection";
...
$query = "SELECT * FROM produk WHERE 
          ...
          LOWER(nama_produk) LIKE '%jacket%' OR
          LOWER(nama_produk) LIKE '%blazer%' OR
          LOWER(nama_produk) LIKE '%suit%'";
...
// Count the number of ready-to-wear products
$totalItems = mysqli_num_rows($result);
?>

<!-- Full-width container for the ready-to-wear collection -->
<div class="ready-to-wear-full-width">
    <!-- Page Header -->
    <div class="page-header">
        <h1>Ready to Wear Collection</h1>
        <p>Discover our curated Secondhand luxury clothing</p>
    </div>
    ...
    <div class="products-grid">
        <?php
        // Check if there are any ready-to-wear products
        if ($totalItems > 0) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                // Product image
                echo '<div class="product-image product-item">';
            ...
            echo '<p>No ready-to-wear products are currently available.</p>';
            echo '</div>';
        }
...
<script>
    ...
    function sortProducts(sortOption) {
        window.location.href = 'ready_to_wear.php?sort=' + sortOption;
    }
    ...
    // ADD THIS TO THE END OF YOUR SCRIPT SECTION IN ready_to_wear.php
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    productImages.forEach(function(img) {
        img.addEventListener('click', function(e) {
            ...
            // Get product ID from the link if needed (for potential API calls)
            const productInfoSection = this.closest('.product-card').querySelector('.product-info');
            const productLink = productInfoSection ? productInfoSection.querySelector('h3 a') : null;
            const productID = productLink ? productLink.getAttribute('href').split('=')[1] : '';
            ...
            // Create array of images for this product (for demonstration)
            // In a real scenario, you'd fetch related images from the database
            let imgSrc = this.src;
            
            // Create an array of images for carousel
            window.productImages = [imgSrc]; // First image is the clicked image
            
            // Add "jacket2.jpg" as the next image for demonstration
            // You would normally get this from your database
            window.productImages.push('images/jacket2.jpg');
            
            // Set image source and product info
            modalImg.src = window.productImages[currentImageIndex];
